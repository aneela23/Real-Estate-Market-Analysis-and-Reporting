...
with engine.connect() as conn:
    try:
        ...
        gc = gspread.service_account(filename=r"C:\Users\aneel\Downloads\Scripts\Scripts\Python_scripts\service_account.json")

        loop_counter = 0
        chunk_size = 100
        file_name = 'OTODOM_ANALYSIS_'
        user_email = 'aneelagarapati23@gmail.com'
